...
```shell
go run github.com/vxcontrol/langchaingo/examples/openai-completion-example@main-vxcontrol
```
...
Here is the entire program (from [openai-completion-example](https://github.com/vxcontrol/langchaingo/blob/main/examples/openai-completion-example/openai_completion_example.go)).

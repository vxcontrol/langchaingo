...
func parseFlags() Config {
	...
	flag.StringVar(&config.PkgGoDevURL, "pkg-url", "https://pkg.go.dev/github.com/vxcontrol/langchaingo", "pkg.go.dev base URL")
	flag.StringVar(&config.ModulePath, "module", "github.com/vxcontrol/langchaingo", "Go module path")

...
func TestResolveOff(t *testing.T) {
	...
	cases := []struct {
		...
		{"claude-sonnet-5", ProviderOpenAI, OffDisableThinkingObject},
		{"bedrock/us.anthropic.claude-sonnet-5", ProviderOpenAI, OffDisableThinkingObject},
		{"vertex_ai/claude-opus-5", ProviderOpenAI, OffDisableThinkingObject},
		{"deepinfra/anthropic/claude-opus-5", ProviderOpenAI, OffUnsupported},
		{"perplexity/anthropic/claude-sonnet-5", ProviderOpenAI, OffUnsupported},
		{"openrouter/anthropic/claude-sonnet-5", ProviderOpenAI, OffUnsupported},
		{"azure_ai/claude-opus-5", ProviderOpenAI, OffUnsupported},
